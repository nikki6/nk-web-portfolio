...
<!--                <img src="upload/iphone.png" height="532" width="252" alt="" class="header-img">-->
                <div class="header-wrapper">
                    <h1>Frederick Women's Rugby <span>Football </span>Club</h1>
                    <p>Founded in 2004 by a group of amazing women who all wanted to play rugby.</p>
                    <p class="autor"><a href="#">Minnow</a></p>
<!--
                ...
                <div class="wrap">
                    <div class="promo-wrapper clearfix">
                        <div class="promo-column">
                            ...
                            <h5>Our Field</h5>
                            <p>The Tobin Treible Memorial Field is located at 1166 Rocky Springs Rd in Frederick, Maryland.</p>
                        </div>
                        <div class="promo-column">
                            <img src="upload/settings.png" height="32" width="33" alt="">
                            <h5>The Team</h5>
                            <p>View the roster and alumni here.</p>
                        </div>
                        <div class="promo-column">
                            <img src="upload/easy.png" height="32" width="34" alt="">
                            <h5>Schedule</h5>
                            <p>We are part of the Division II South Matrix.</p>
                        </div>
<!--
                        <div class="promo-column">
